class Game{
	constructor(){
		...
		const game = this;
		this.anims = ['hazmatWalking', 'hazmatWalking Backwards', 'hazmatTurn', 'hazmatRunning', 'hazmatPointing', 'hazmatTalking', 'hazmatPointing Gesture', 'mocapWalking', 'mocapWalking Backwards', 'mocapTurn', 'mocapRunning', 'mocapPointing', 'mocapTalking', 'mocapPointing Gesture'];
		...
		options.assets.push(`https://virtual-event-space.s3-eu-west-1.amazonaws.com/warehouse.fbx`);
...
class Player{
	constructor(game, options){
		...
		loader.load( `https://virtual-event-space.s3-eu-west-1.amazonaws.com/${model}.fbx`, function ( object ) {
			...
			if (model == "hazmat") {
				game.animations.hazmatIdle = object.animations[0];
			} else {
			...
			if (model == "hazmat") {
				if (game.animations.hazmatIdle!==undefined) player.action = "Idle";
			} else {
				if (game.animations.mocapIdle!==undefined) player.action = "Idle";
			}
